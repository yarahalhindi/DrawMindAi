    ...
    <Animated.View style={[dc.card, { opacity: mountAnim, transform: [{ translateY: mountAnim.interpolate({ inputRange: [0, 1], outputRange: [20, 0] }) }] }]}>
      ...
      <Animated.View style={{ maxHeight: expandAnim.interpolate({ inputRange: [0, 1], outputRange: [0, 440] }), opacity: expandAnim, overflow: "hidden" }}>
        <View style={dc.expanded}>
          ...
          <View style={[dc.stateChip, { backgroundColor: "#EDE9FF", marginTop: 10 }]}>
          ...
          <TouchableOpacity style={dc.fullBtn} onPress={() => router.push({ pathname: "/drawing-detail", params: { drawingId: drawing.id } })}>
            <LinearGradient colors={["#6C4DFF", "#9B7FFF"]} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} style={dc.fullBtnInner}>
      ...
      <Pressable onPress={toggleExpand} style={dc.toggle}>
        ...
        <Ionicons name={expanded ? "chevron-up" : "chevron-down"} size={14} color="#6C4DFF" />
      </Pressable>
    </Animated.View>
  );
}
...
const dc = StyleSheet.create({
  card:     { backgroundColor: "#FFFFFF", borderRadius: 24, padding: 16, marginBottom: 14, shadowColor: "#6C4DFF", shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.09, shadowRadius: 18, elevation: 6 },
  ...
  info:      { flex: 1, gap: 7 },
  title:     { fontSize: 15, fontWeight: "700", color: "#1A0F2E", fontFamily: "Inter_700Bold" },
  ...
  pillLabel: { fontSize: 10, color: "#8B7BAB", fontFamily: "Inter_400Regular" },
  pill2:     { flexDirection: "row", alignItems: "center", gap: 4 },
  pillLabel2: { fontSize: 10, color: "#8B7BAB", fontFamily: "Inter_400Regular" },
  ...
  sectionLabel: { fontSize: 11, fontWeight: "700", color: "#8B7BAB", fontFamily: "Inter_700Bold", letterSpacing: 0.6, textTransform: "uppercase", marginBottom: 10 },
  ...
  infoItem:  { gap: 3 },
  infoLabel: { fontSize: 10, fontWeight: "700", color: "#8B7BAB", fontFamily: "Inter_700Bold", textTransform: "uppercase", letterSpacing: 0.4 },
  ...
  recDot:    { width: 6, height: 6, borderRadius: 3, backgroundColor: "#6C4DFF", marginTop: 5 },
  ...
  toggleText: { fontSize: 12, fontWeight: "700", color: "#6C4DFF", fontFamily: "Inter_700Bold" },
});
...
export default function ChildProfileScreen() {
  ...
  const emotionBars = Object.entries(emotionCounts).map(([name, count]) => ({
    ...
    color: EMOTION_CONFIG[name]?.color ?? "#6C4DFF",
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.navRow}>
          ...
          >
            <Ionicons name="pencil" size={16} color="#6C4DFF" />
          </TouchableOpacity>
        </View>
        ...
        >
          ...
          {child.favoriteActivities ? (
            <View style={styles.activitiesChip}>
              <Ionicons name="star-outline" size={12} color="#6C4DFF" />
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.85}
          >
            <Ionicons name="pencil-outline" size={15} color="#6C4DFF" />
        ...
        <View style={styles.aiCard}>
          ...
          >
            ...
            <View style={styles.aiChipRow}>
              <View style={[styles.aiChip, { backgroundColor: (EMOTION_CONFIG[dominantEmotion]?.color ?? "#6C4DFF") + "20" }]}>
                <Text style={[styles.aiChipLabel, { color: EMOTION_CONFIG[dominantEmotion]?.color ?? "#6C4DFF" }]}>
            ...
            <View style={styles.aiInsightRow}>
              <View style={styles.aiInsightIcon}>
                <Ionicons name="sparkles" size={15} color="#6C4DFF" />
              </View>
        ...
        {childDrawings.length > 0 ? (
          ...
          <View style={styles.emptyDrawings}>
            <LinearGradient colors={["#EDE9FF", "#F5F1FF"]} style={styles.emptyDrawingsIcon}>
            ...
            <TouchableOpacity onPress={() => router.push("/choose-child")} activeOpacity={0.85}>
              <LinearGradient colors={["#6C4DFF", "#9B7FFF"]} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} style={styles.emptyDrawingsBtn}>
...
const styles = StyleSheet.create({
  ...
  backBtn: { width: 40, height: 40, borderRadius: 20, backgroundColor: "#FFFFFF", alignItems: "center", justifyContent: "center", shadowColor: "#6C4DFF", shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.1, shadowRadius: 8, elevation: 4 },
  navTitle: { fontSize: 18, fontWeight: "700", color: "#1A0F2E", fontFamily: "Inter_700Bold" },
  editNavBtn: { width: 40, height: 40, borderRadius: 20, backgroundColor: "#EDE9FF", alignItems: "center", justifyContent: "center" },
  ...
  heroName: { fontSize: 26, fontWeight: "800", color: "#1A0F2E", fontFamily: "Inter_700Bold", letterSpacing: -0.5, marginBottom: 4 },
  heroMeta: { fontSize: 14, color: "#8B7BAB", fontFamily: "Inter_400Regular", marginBottom: 10 },
  activitiesChip: { flexDirection: "row", alignItems: "center", gap: 6, backgroundColor: "#FFFFFF", paddingHorizontal: 14, paddingVertical: 6, borderRadius: 20, marginBottom: 18 },
  activitiesText: { fontSize: 12, color: "#6C4DFF", fontFamily: "Inter_500Medium" },
  heroStats: { flexDirection: "row", width: "100%", borderRadius: 20, backgroundColor: "#FFFFFF", paddingVertical: 14, marginBottom: 16 },
  heroStat: { flex: 1, alignItems: "center" },
  heroStatNum: { fontSize: 20, fontWeight: "800", fontFamily: "Inter_700Bold" },
  heroStatLabel: { fontSize: 11, color: "#8B7BAB", fontFamily: "Inter_400Regular", marginTop: 2 },
  heroStatDivider: { width: 1, backgroundColor: "#F0ECFF" },
  editProfileBtn: { flexDirection: "row", alignItems: "center", gap: 7, paddingHorizontal: 20, paddingVertical: 10, borderRadius: 20, backgroundColor: "#FFFFFF", borderWidth: 1.5, borderColor: "#DDD6FF" },
  editProfileText: { fontSize: 13, fontWeight: "700", color: "#6C4DFF", fontFamily: "Inter_700Bold" },

  /* ── Section header ── */
  sectionHeader: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginBottom: 14 },
  sectionTitle: { fontSize: 19, fontWeight: "700", color: "#1A0F2E", fontFamily: "Inter_700Bold", letterSpacing: -0.3 },
  sectionCount: { fontSize: 13, color: "#8B7BAB", fontFamily: "Inter_500Medium" },

  /* ── AI Card ── */
  aiCard: { borderRadius: 24, overflow: "hidden", marginBottom: 24, shadowColor: "#6C4DFF", shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.08, shadowRadius: 16, elevation: 4 },
  ...
  aiBarsLabel: { fontSize: 11, fontWeight: "700", color: "#8B7BAB", fontFamily: "Inter_700Bold", textTransform: "uppercase", letterSpacing: 0.5, marginBottom: 12 },
  aiNotes: { borderTopWidth: 1, borderTopColor: "#E8E2FF", paddingTop: 14, marginTop: 8, gap: 12 },
  aiNoteItem: { gap: 4 },
  aiNoteLabel: { fontSize: 10, fontWeight: "700", color: "#8B7BAB", fontFamily: "Inter_700Bold", textTransform: "uppercase", letterSpacing: 0.4 },
  ...
  emptyDrawingsTitle: { fontSize: 17, fontWeight: "700", color: "#1A0F2E", fontFamily: "Inter_700Bold" },
  emptyDrawingsSub: { fontSize: 13, color: "#8B7BAB", fontFamily: "Inter_400Regular", textAlign: "center", lineHeight: 20, maxWidth: 260 },
  emptyDrawingsBtn: { flexDirection: "row", alignItems: "center", gap: 8, paddingHorizontal: 24, paddingVertical: 13, borderRadius: 20, shadowColor: "#6C4DFF", shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.28, shadowRadius: 14, elevation: 8 },
